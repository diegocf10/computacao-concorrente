...
int main() {
  ...
  for(thread=0; thread<NTHREADS; thread++) {
    ...
    // passa o número da thread como argumento
...
/****
 *
 * 1) As threads são criadas e escalonadas de forma não determinística pelo processador
 * 2) Por isso, a saída pode diferir em cada execução
 *
*/
