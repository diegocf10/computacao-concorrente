...
/***
 * Aqui pthread_join fará a thread main esperar todas as outras threads terminarem
 * antes de imprimir o thread principal terminou
 * Neste caso, o pthread_exit não é necessário
 *
*/